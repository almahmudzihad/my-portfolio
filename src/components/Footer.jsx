      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded bg-brand-blue/20 border border-brand-blue/40 flex items-center justify-center font-bold text-brand-blue">J</div>
            <span className="font-bold text-lg">Jaydeep</span>
          </div>
